#ifndef LIDAR_MOTION_DETECTION_COMMON_NEIGHBORHOOD_SEARCH_H_
#define LIDAR_MOTION_DETECTION_COMMON_NEIGHBORHOOD_SEARCH_H_
  ...
  explicit NeighborhoodSearch(const int connectivity) {
    if (connectivity == 6) {
      ...
      LOG(ERROR) << "Neighborhood Search only supports connectivities of 6, "
                    "18, and 26 (requested: " << connectivity <<").";
    }
  }
...
#endif  // LIDAR_MOTION_DETECTION_COMMON_NEIGHBORHOOD_SEARCH_H_